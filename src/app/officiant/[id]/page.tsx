  ...
  return (
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        <div className="card">
          {/* Avatar */}
          <div className="w-24 h-24 bg-[var(--secondary)] rounded-full flex items-center justify-center text-3xl font-bold text-[var(--primary-dark)] mx-auto mb-4">
            {initials}
          </div>
          ...
          {/* Location */}
          <p className="text-[var(--muted)] text-center mb-6 flex items-center justify-center gap-1">
            <svg
              className="w-4 h-4"
              fill="none"
              stroke="currentColor"
          ...
          <div className="border-t border-[var(--border)] pt-4 mt-4">
            ...
            <p className="text-[var(--foreground)]">{officiant.affiliation}</p>
          </div>

          {/* Contact Info (if claimed and approved) */}
          {approvedClaim && (
            <div className="border-t border-[var(--border)] pt-4 mt-4">
              <div className="flex items-center gap-2 text-sm text-[var(--primary)] font-medium mb-3">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 20 20"
